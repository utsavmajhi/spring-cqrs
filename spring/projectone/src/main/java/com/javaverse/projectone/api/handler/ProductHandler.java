...
public class ProductHandler {
    ...
    public Mono<ServerResponse> save(ServerRequest req) {
        return ok().contentType(MediaType.APPLICATION_STREAM_JSON)
                .body(Mono.defer(() -> req.bodyToMono(Example.class)).log().doOnNext(repo::save).subscribeOn(Schedulers.parallel()), Example.class);
    }
    ...
    public Mono<ServerResponse> get(ServerRequest req) {
        ...
        return ok().contentType(MediaType.APPLICATION_STREAM_JSON)
                ...
                .body(Mono.defer(() -> repo.get(req.pathVariable("id"))).log().subscribeOn(Schedulers.parallel()), Example.class)
