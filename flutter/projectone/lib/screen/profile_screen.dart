...
//																height: 200,
																child: Center(
																	child: CircleAvatar(
																		radius: 90,
																		backgroundImage: _imageFile == null ? AssetImage('images/dutchmill-logo.png') : FileImage(_imageFile),
																	),
...
//													Expanded(flex: 1,child: Container(),),
													...
													Expanded(child: Container(child: Align(alignment: Alignment.centerLeft, child: Row(
														children: <Widget>[
															...
															Padding(padding: EdgeInsets.symmetric(horizontal: 10),),
															Text('Nattaphon Jeamjit', style: Theme
																.of(context)
																.textTheme
																.body2,),
														],
